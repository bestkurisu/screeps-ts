 ...
 * 调用 next 可以执行实际业务逻辑
 */
export type ErrorCatcher = <T extends (...args: unknown[]) => unknown>(next: ((creep: Creep) => unknown) | ((room: Room) => unknown) | ((creep: PowerCreep) => unknown) | undefined, ...args: unknown[]) => void
